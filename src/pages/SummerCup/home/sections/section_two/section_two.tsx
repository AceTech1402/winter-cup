      ...
      <div className={classes.section_two}>
        <div className={classes.container}>
          ...
          <div className={classes.explain}>
            <p>
              Nach dem großen Erfolg des Sommercups am <span>12. Juli</span> in
              Wien, wird das Event nun auf ganz Österreich ausgeweitet.
            </p>
            <p>
          ...
          <div className={classes.explain}>
            <p>
              Das Turnier wird in Kooperation mit dem Österreichischen Kleinfeld
              Fußball Bund gespielt.Insgesamt <span>16 Teams</span> finden bei
              diesem Turnier einen Startplatz (pro Standort). Es wird auf zwei
              Spielfelder simultan gespielt. Das Turnier startet um 10:00 für
              alle Mannschaften. Geleitet wird das Event von Schiedsrichtern des
              ÖKFB.
            </p>
            <p>
